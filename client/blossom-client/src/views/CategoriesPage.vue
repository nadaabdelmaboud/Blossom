  ...
  <div class="categoriesPage">
    ...
    <ul>
      <li v-for="bouquetsCard in bouquetCategories" :key="bouquetsCard">
        ...
        <img
          ...
          @click="deleteCategories(bouquetsCard, 'bouquets')"
          alt="trash icon"
    ...
    <ul>
      <li v-for="plantCard in plantCategories" :key="plantCard">
        ...
        <img
          src="../assets/trash.svg"
          @click="deleteCategories(plantCard, 'plant')"
          alt="trash icon"
          v-if="status == 'success' && isAdmin == true"
        />
      </li>
    ...
    <ul>
      <li v-for="sentimentCard in bouquetSentiments" :key="sentimentCard">
        ...
        <img
          src="../assets/trash.svg"
          @click="deleteCategories(sentimentCard, 'sentiment')"
          alt="trash icon"
          v-if="status == 'success' && isAdmin == true"
        />
      </li>
...
export default {
  ...
  methods: {
    ...
    selectBouquets(bouquet, sentiment) {
      ...
      if (bouquet != "") this.$store.commit("homePage/setCateogry", bouquet);
      else this.$store.commit("homePage/setSentiment", sentiment);
      this.$router.push("/");
    },
    selectPlant(plant) {
      this.$store.commit("homePage/setHomeCards", []);
